...
export default function GeneratorPage({ params }: GeneratorPageProp) {
  const router = useRouter();
  const [selectedType, setSelectedType] = useState<ContentType>(params.templateId);
  ...
  useEffect(() => {
    if (params?.templateId) {
      setSelectedType(params.templateId as ContentType);
    }
  }, [params?.templateId]);
